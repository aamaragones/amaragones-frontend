document.addEventListener("DOMContentLoaded", () => {
    ...
    const initializeStack = (cardsContainer) => {
        let stack = null;
        let cards = [];
        let listeners = [];
        ...
        const createStack = () => {
            ...
            stack.setAttribute("aria-label", cardsContainer.getAttribute("aria-label") || "Obras destacadas");
    ...
    containers.forEach(initializeStack);
});
